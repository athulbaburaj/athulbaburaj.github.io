  ...
  return (
    <section className="relative bg-black text-white py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        <div 
          className="absolute top-1/4 -left-1/4 w-96 h-96 bg-indigo-900 rounded-full opacity-30 blur-2xl animate-swirl"
        />
        <div 
          className="absolute bottom-1/4 -right-1/4 w-96 h-96 bg-purple-900 rounded-full opacity-20 blur-3xl animate-swirl"
          style={{ animationDelay: '-12s' }}
        />
         <div 
          className="absolute bottom-1/2 right-1/4 w-64 h-64 bg-indigo-800 rounded-full opacity-20 blur-2xl animate-swirl"
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="inline-flex items-center justify-center bg-gray-900/80 border border-indigo-500/50 text-indigo-300 px-4 py-2 rounded-full text-sm mb-10 shadow-lg shadow-indigo-500/10">
          ...
          {/* ADDED animate-spin to this icon for our test */}
          <GoVerified className="mr-2 text-indigo-400 animate-spin" /> 
